...
public class ApplicationsDeployedActivity extends Cloud4SoaActivity implements
	...
	/* (non-Javadoc)
	 * @see eu.cloud4soa.frontend.widget.monitoring.client.views.ApplicationsDeployedView.Presenter#onCommitApplicationMigration(eu.cloud4soa.frontend.commons.client.datamodel.frontend.application.ApplicationModel)
	 */
	@Override
	public void onCommitApplicationMigration(final ApplicationModel app) {
		deployedappsService.commitMigration(app.getKey(), new AsyncCallback<Void>(){

			@Override
			public void onFailure(Throwable caught) {
				DialogHelper
				.showErrorDialog("There was an error while trying to commit the migrate application"
						+ "\nPlease, contact site administrator");
			}

			@Override
			public void onSuccess(java.lang.Void result) {
				DialogHelper.showConfirmationDialog("Committing Migration", "The migration of application " + app.getTitle() + " was successfully committed");
				retrieveDeployedApps();
			}
		});
	}
	...
	/* (non-Javadoc)
	 * @see eu.cloud4soa.frontend.widget.monitoring.client.views.ApplicationsDeployedView.Presenter#onRollbackApplicationMigration(eu.cloud4soa.frontend.commons.client.datamodel.frontend.application.ApplicationModel)
	 */
	@Override
	public void onRollbackApplicationMigration(final ApplicationModel app) {
		deployedappsService.rollbackMigration(app.getKey(), new AsyncCallback<Void>(){

			@Override
			public void onFailure(Throwable caught) {
				DialogHelper
				.showErrorDialog("There was an error while trying to rollback the migrate application"
						+ "\nPlease, contact site administrator");
			}

			@Override
			public void onSuccess(java.lang.Void result) {
				DialogHelper.showConfirmationDialog("Rollbacking Migration", "The rollback of application " + app.getTitle() + " was successfully committed");
				retrieveDeployedApps();
			}
		});
	}
