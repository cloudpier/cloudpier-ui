...
public class MonitoringActivity extends Cloud4SoaActivity implements
	...
	AsyncCallback<Map<String, Map<MonitoringMetricType, List<IMonitoringMetric>>>> monitoringCallback = new AsyncCallback<Map<String, Map<MonitoringMetricType, List<IMonitoringMetric>>>>() {
		...
		@Override
		public void onSuccess(Map<String, Map<MonitoringMetricType, List<IMonitoringMetric>>> statistics) {
	...
	private void getMonitoringStatistics(
		...
		Map<String, String> appsData = new HashMap<String, String>();
		for (ApplicationModel app : applications)
			appsData.put(app.getKey(), app.<String>get (ApplicationModel.PAAS_PROVIDER_URIID));
