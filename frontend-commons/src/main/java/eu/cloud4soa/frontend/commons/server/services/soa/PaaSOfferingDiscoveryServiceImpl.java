    ...
    public ListLoadResult<PaaSOfferingModel> searchForMatchingPlatform(String applicationInstanceId) {
        ...
        try {
            ...
            for (PaaSInstance instance : rankedPaaSInstances.keySet()) {
                ...
                // Average User Rating
                float averageUserRating = offeringRecommendationSoaService.getAveragePaaSUserExperienceRate(instance.getPaaSOffering().getUriId());
                ...
                float averageSystemRating = offeringRecommendationSoaService.getPaaSBreachesPerMonth(instance.getPaaSOffering().getUriId());
