...
public class PaaSOfferingModel extends DynamicFormModel implements
    ...
    public final static String AVERAGE_USER_RATING = "averageUserRating";
    public final static String AVERAGE_SYSTEM_RATING = "averageSystemRating";
    ...
    /**
     * Matching PaaSOfferingModel are ordered by score (first criterium) and user rating (second criterium), in inverse order
     */
    @Override
    public int compareTo(PaaSOfferingModel o) {
        int result = -1;
        if (this.getScore() == o.getScore()){
        	result =  o.getAverageUserRating() - this.getAverageUserRating();
    ...
    public int getAverageUserRating() {
        return (Integer) get(AVERAGE_USER_RATING);
    }
    
    public int getAverageSystemRating() {
        return (Integer) get(AVERAGE_SYSTEM_RATING);
    }
