...
public class ApplicationEditorSlaMetadata extends EntityMetadata implements IsSerializable {
    ...
    public ApplicationEditorSlaMetadata() {
        ...
        field(FieldMetadata.create(ApplicationModel.SLA_CPU_LOAD)
                .label("CPU Load (%)")
                .editType(EditType.FLOAT)
                .allowNegative(false)
                .tooltip("CPU Load (%)")
        ...
        field(FieldMetadata.create(ApplicationModel.SLA_MEMORY_LOAD)
                .label("Memory Load (%)")
                .editType(EditType.FLOAT)
                .allowNegative(false)
                .tooltip("Memory Load (%)")
        ...
        field(FieldMetadata.create(ApplicationModel.SLA_CLOUD_RESPONSE_TIME)
                .label("Cloud Response Time (ms)")
                .editType(EditType.FLOAT)
                .allowDecimals(false)
                .allowNegative(false)
                .tooltip("Cloud Response Time (ms)")
        );
        
        field(FieldMetadata.create(ApplicationModel.SLA_CONTAINER_RESPONSE_TIME)
                .label("Container Response Time (ms)")
                .editType(EditType.FLOAT)
                .allowDecimals(false)
                .allowNegative(false)
                .tooltip("Container Response Time (ms)")
        );
