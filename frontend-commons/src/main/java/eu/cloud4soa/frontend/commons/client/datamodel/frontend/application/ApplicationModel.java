...
public class ApplicationModel extends DynamicFormModel implements IsSerializable, WithDescription, WithTitle {
    ...
    public final static String STATUS_MIGRATED = "Migrated";
    ...
    public static final String SLA_CPU_LOAD = "cpuload";
    public static final String SLA_MEMORY_LOAD = "memoryload"; 
    public static final String SLA_CLOUD_RESPONSE_TIME = "cloudresponsetime";
    public static final String SLA_CONTAINER_RESPONSE_TIME = "containerresponsetime";
    ...
    public static final String SUPPORTED_METRICS = "supportedMetrics";
