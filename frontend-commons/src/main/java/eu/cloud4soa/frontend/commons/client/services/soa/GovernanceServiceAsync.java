...
public interface GovernanceServiceAsync extends RemoteService {
    ...
    */
    ...
    void whiteList3(AsyncCallback<SLAContractGuaranteeTermModel> async) throws GwtSecurityException;
    void whiteList4(AsyncCallback<SLAContractGuaranteeTermSLOModel> async) throws GwtSecurityException;
    void whiteList5(AsyncCallback<SLAContractGuaranteeTermBLOModel> async) throws GwtSecurityException;
}
