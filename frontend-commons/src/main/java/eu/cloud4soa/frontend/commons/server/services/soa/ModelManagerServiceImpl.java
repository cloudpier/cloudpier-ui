...
import eu.cloud4soa.frontend.commons.server.semanticdao.ApplicationDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.CommunicationalCategoryDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.ComputationalCategoryDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.DbDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.DeveloperUserDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.DynamicEntityManager;
import eu.cloud4soa.frontend.commons.server.semanticdao.HardwareCategoryDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.NoSqlDbDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.PaaSOfferingDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.ProgrammingLanguageDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.ProviderUserDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.SoftwareCategoryDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.SqlDbDao;
import eu.cloud4soa.frontend.commons.server.semanticdao.StorageCategoryDao;
...
public class ModelManagerServiceImpl extends RemoteServiceServlet implements ModelManagerService {
    ...
    public ListLoadResult<ApplicationModel> retrieveAllDeployedApplicationProfiles(ListLoadConfig config) throws GwtSecurityException {
        ...
        try {
            ...
            for (ApplicationModel am : lam) {
                ...
                List<ServiceQualityInstance> supportedMetrics = monitoringModule.getSupportedMetrics(am.<String>get(ApplicationModel.PAAS_PROVIDER_URIID));
        		am.set(ApplicationModel.SUPPORTED_METRICS, translateServiceQualityInstance(supportedMetrics));
            }
    ...
    @Override
    public MonitoringMetricType whiteList5() {
        return null;
    }
