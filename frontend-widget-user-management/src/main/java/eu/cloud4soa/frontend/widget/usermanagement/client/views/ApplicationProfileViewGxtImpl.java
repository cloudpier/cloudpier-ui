...
public class ApplicationProfileViewGxtImpl extends Composite implements
    ...
    /**
	 * Updates deploy button labels depending on current place
	 */
	private void updateDeployButton() {
		if (this.presenter.isMigrationPlace()){
			deployButton.setText("Migrate");
			deployButton.setToolTip("Migrate an application matching this profile onto the selected PaaS Offering");
		}
	}
