...
import eu.cloud4soa.frontend.commons.client.places.DeployPlace;
...
public class ApplicationProfileActivity extends Cloud4SoaActivity implements
	...
	/* (non-Javadoc)
	 * @see eu.cloud4soa.frontend.widget.usermanagement.client.views.ApplicationProfileView.Presenter#isMigrationPlace()
	 */
	@Override
	public boolean isMigrationPlace() {
		return (place instanceof MigratePlace);
	}
}
