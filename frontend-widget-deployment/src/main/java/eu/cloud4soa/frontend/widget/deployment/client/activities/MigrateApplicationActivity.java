...
public class MigrateApplicationActivity extends Cloud4SoaActivity implements MigrateApplicationView.Presenter {
    ...
    private UserCredentialsModel storedUserCredentialsModel;
    ...
    private void askCredentials() {
        ...
        userService.readUserCredentialsForPaaS(offeringUriId, new AsyncCallback<UserCredentialsModel>() {
            ...
            public void onFailure(Throwable caught) {
                ...
                storedUserCredentialsModel = null;
            ...
            public void onSuccess(UserCredentialsModel result) {
                ...
                storedUserCredentialsModel = result.createClone();
                view.bindCredentialsForm(userCredentialsModel);
            }
        });
    ...
    public void onCredentialsAccepted() {
        ...
        if (storedUserCredentialsModel == null || 
        	storedUserCredentialsModel.get(UserCredentialsModel.PUBLIC_KEY)==null ||
        	storedUserCredentialsModel.get(UserCredentialsModel.PUBLIC_KEY).equals("") ||
        	storedUserCredentialsModel.get(UserCredentialsModel.PRIVATE_KEY)==null ||
        	storedUserCredentialsModel.get(UserCredentialsModel.PRIVATE_KEY).equals("")) //New credentials
        ...
        else if (!userCredentialsModel.get(UserCredentialsModel.PUBLIC_KEY).equals(storedUserCredentialsModel.get(UserCredentialsModel.PUBLIC_KEY)) ||
            	!userCredentialsModel.get(UserCredentialsModel.PRIVATE_KEY).equals(storedUserCredentialsModel.get(UserCredentialsModel.PRIVATE_KEY)) ||
            	!userCredentialsModel.get(UserCredentialsModel.ACCOUNT_NAME).equals(storedUserCredentialsModel.get(UserCredentialsModel.ACCOUNT_NAME)))
        ...
        else //No changes in credentials
        	checkIfMigrationNeedsToBeDoneViaCli();
    }
