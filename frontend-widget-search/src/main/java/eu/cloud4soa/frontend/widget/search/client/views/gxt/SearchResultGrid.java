...
public class SearchResultGrid extends CardPanel {
	...
	private int numberOfResultsShownPerPage = 20;
	...
	private void createGridView(List<Offering> offerings) {
		...
		toolBar = new PagingToolBar(numberOfResultsShownPerPage);
		toolBar.bind(loader);
		loader.load(0, numberOfResultsShownPerPage);
		...
		ColumnConfig userRatingConfig = new ColumnConfig("averageUserRating", "User Rating", 100);
		userRatingConfig.setRenderer(ratingRenderer);
		columns.add(userRatingConfig);
		
		ColumnConfig systemRatingConfig = new ColumnConfig("averageSystemRating", "System Rating", 100);
		systemRatingConfig.setToolTip("Number of breaches per month occurring in the PaaS offering");
//		systemRatingConfig.setRenderer(ratingRenderer);
		columns.add(systemRatingConfig);
